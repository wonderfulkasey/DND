...
Gem::Specification.new do |spec|
  ...
  spec.authors       = ["'Kasey Arnold'"]
  spec.email         = ["'wonderfulkasey@gmail.com'"]

  spec.summary       = %q{"A command line interface to look through Dungeons and Dragons 5th Edition information."}
  spec.homepage      = "https://github.com/wonderfulkasey/"
  spec.license       = "MIT"
